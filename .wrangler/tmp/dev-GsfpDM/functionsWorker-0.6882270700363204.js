...
// .wrangler/tmp/pages-q7nEGB/functionsWorker-0.6882270700363204.mjs
...
async function onRequestPost(context22) {
  ...
  try {
    ...
    return Response.json(
      {
        success: false,
        error: error32.message || "Login failed"
      },
      { status: 500 }
    );
  }
...
async function onRequestGet(context22) {
  ...
  try {
    ...
    console.error("Get user error:", error32);
    return Response.json(
      {
        success: false,
...
__name(getUserIdFromToken2, "getUserIdFromToken2");
...
var init_use_setup = __esm({
  "api/user/use-setup.ts"() {
    ...
    init_performance2();
    init_db_simple();
    __name2(getUserIdFromToken2, "getUserIdFromToken");
...
async function onRequestGet5(context22) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: error32.message }), { status: 500 });
  }
}
...
__name(getUserIdFromToken3, "getUserIdFromToken3");
...
var init_setups = __esm({
  "api/setups.ts"() {
    ...
    init_performance2();
    init_db_simple();
    __name2(getUserIdFromToken3, "getUserIdFromToken");
...
// .wrangler/tmp/bundle-u683GS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-u683GS/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6882270700363204.js.map
