  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-16 text-gray-300">
      ...
      <section id="privacy" className="mb-16 scroll-mt-20">
        ...
        <p className="mb-4">
          We value your privacy. MZPrimer Intelligence collects minimal personal data required to deliver services, such as email and interaction logs for our AI tools. Data is stored securely and never sold.
        </p>
        <p className="mb-4">
      ...
      <section id="terms" className="mb-16 scroll-mt-20">
        ...
        <p className="mb-4">
          By using MZPrimer Intelligence services, you agree not to misuse the tools or attempt to bypass access controls. Our tools are provided “as is” without guarantees of performance or market accuracy.
        </p>
        <p className="mb-4">
          You may not redistribute or resell any tools, code, or assets without written permission. All rights are reserved by MZPrimer Intelligence LTD.
        </p>
        <p>
      ...
      <section id="disclaimer" className="scroll-mt-20">
        ...
        <p className="mb-4">
          MZPrimer Intelligence does not provide financial advice. All simulations, indicators, and educational content are designed for informational purposes only.
        </p>
        <p className="mb-4">
