...
export default function AboutPage() {
  return (
    <main className="section-container about-container">
      <h1 className="section-title">👋 About MPIntellect </h1>

      <p className="about-text">
        MPIntellect  is a premium digital platform. We are built to empower traders with cutting-edge AI tools, institutional-grade simulations, and real-time market data. We help you deconstruct market structure and simulate setups to gain a deeper understanding of market behavior—before you risk capital.
      </p>

      <p className="about-text">
        Our mission is simple: democratize smart trading technology and make it accessible to every trader—whether you're just getting started or scaling a professional strategy. No signals. No get-rich-quick promises. Just the  you need to make smarter, more confident trading decisions.
      </p>
      ...
      <ul className="about-list">
        ...
        <li><strong>AI ChatBox:</strong> Validate your trading setups and receive real-time  through our specialized financial AI agent.</li>
        ...
        <li><strong> Feed:</strong> Live fundamental analysis and breaking news categorized by asset class, keeping you ahead of market volatility.</li>
