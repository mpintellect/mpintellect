...
export async function onRequestGet(context: any) {
  ...
  try {
    ...
    const partnerLogoUrl = `https://news.mzprimer.com/lfmo1ee.webp`;
  ...
  RELEASED: ${story.date}
       ...
       <!-- MAIN HEADLINE BLOCK -->
        <div class="headline-card" style="margin-bottom: 60px;">
          <h2 class="headline-text" style="font-size: 70px; font-weight: 700; color: white; text-align: left; direction: ltr;">
            ${story.headline}
          </h2>
        </div>
        ...
        <!-- CONTEXT AREA -->
        <div style="flex: 1;">
          <div style="border-left: 4px solid ${gold}; padding-left: 30px; margin-bottom: 60px; border-right: none;">
            <p style="font-size: 40px; font-weight: 300; color: #e2e8f0; line-height: 1.6; text-align: left; direction: ltr;">
              "${story.aiContext}"
            </p>
          </div>
          ...
          <div style="display: flex; gap: 80px; margin-top: 20px;">
            <div class="metric-box" style="border-color: ${gold}40;">
              ...
              <span style="font-size: 49px; font-weight: 700; color: ${gold};">${story.impact}</span>
            </div>
          </div>
        </div>
