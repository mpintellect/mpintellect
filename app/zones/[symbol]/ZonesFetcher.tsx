...
export default function ZonesFetcher({ symbol }: { symbol: string }) {
  ...
  const fetchSymbolData = async () => {
    try {
      ...
      console.log(`[ZonesFetcher] Fetching ${cleanSymbol} from /api/symbol-data`);
      ...
      setData(result);
      console.log(`[ZonesFetcher] Data loaded for ${cleanSymbol}`);
      
    } catch (err) {
      console.error(`[ZonesFetcher] Error:`, err);
