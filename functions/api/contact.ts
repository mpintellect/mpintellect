...
export async function onRequestPost(context: any) {
  ...
  try {
    ...
    // Bot Protection: If honeypot is filled, stop here
    if (hp) {
      ...
      html: `
        <div style="background:#000; color:#fff; padding:40px; font-family:sans-serif; border:1px solid #D4AF37;">
          ...
          <div style="background:#0a0a0a; padding:20px; border:1px solid #111;">
            ...
            <p style="margin:20px 0 10px 0; color:#555; text-transform:uppercase; font-size:10px; font-weight:bold;">Message:</p>
