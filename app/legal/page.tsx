  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-16 text-gray-300">
      ...
      <section id="privacy" className="mb-16 scroll-mt-20">
        ...
        <p className="mb-4">
          We value your privacy. MPIntellect  collects minimal personal data required to deliver services, such as email and interaction logs for our AI tools. Data is stored securely and never sold.
        </p>
        <p className="mb-4">
        ...
        <p>
          If you wish to delete or access your data, please contact us at: <a href="mailto:info@mpintellect.com" className="text-yellow-400 underline">info@mpintellect.com</a>
        </p>
      </section>
      ...
      <section id="disclaimer" className="scroll-mt-20">
        ...
        <p className="mb-4">
          MPIntellect  does not provide financial advice. All simulations, indicators, and educational content are designed for informational purposes only.
        </p>
        <p className="mb-4">
